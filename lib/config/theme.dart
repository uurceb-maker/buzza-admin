...
class AppTheme {
  // Primary palette
  static const Color primary = Color(0xFFFACC15); // Buzza Yellow
  static const Color primaryLight = Color(0xFFFDE047);
  static const Color primaryDark = Color(0xFFEAB308);

  // Legacy field name kept for compatibility across existing screens.
  static const Color accentPink = Color(0xFFD97706);

  // Background & Surface
  static const Color bgDark = Color(0xFF09090B);
  static const Color bgCard = Color(0xFF18181B);
  static const Color bgSurface = Color(0xFF27272A);
  ...
  static const LinearGradient appBackgroundGradient = LinearGradient(
    colors: [Color(0xFF09090B), Color(0xFF121214), Color(0xFF09090B)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient panelGradient = LinearGradient(
    colors: [Color(0xCC18181B), Color(0xB018181B)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
